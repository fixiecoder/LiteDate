...
const FORMAT_PARTS_FN_MAP = {
  ...
  [FORMAT_PARTS.MINUTES]: { fn: 'getMinutes', args: [] },
  [FORMAT_PARTS.MINUTES_PADDED]: { fn: 'getMinutes', args: [true] },
  ...
  [FORMAT_PARTS.EPOCH_MS]: { fn: 'getSeconds', args: [] },
  [FORMAT_PARTS.EPOCH_S]: { fn: 'getSeconds', args: [] },
  [FORMAT_PARTS.DAY_NAME_LONG]: { fn: 'getSeconds', args: [] },
  [FORMAT_PARTS.DAY_NAME_SHORT]: { fn: 'getSeconds', args: [] },
  [FORMAT_PARTS.DATE_ORDINAL]: { fn: 'getSeconds', args: [] },
  [FORMAT_PARTS.DATE]: { fn: 'getSeconds', args: [] },
  [FORMAT_PARTS.DATE_PADDED]: { fn: 'getSeconds', args: [] },
  [FORMAT_PARTS.MONTH]: { fn: 'getSeconds', args: [] },
  [FORMAT_PARTS.MONTH_PADDED]: { fn: 'getSeconds', args: [] },
  [FORMAT_PARTS.MONTH_NAME_SHORT]: { fn: 'getSeconds', args: [] },
  [FORMAT_PARTS.MONTH_NAME_LONG]: { fn: 'getSeconds', args: [] },
  [FORMAT_PARTS.YEAR]: { fn: 'getSeconds', args: [] },
  [FORMAT_PARTS.YEAR_FULL]: { fn: 'getSeconds', args: [] },
};
