...
const FORMAT_PARTS_FN_MAP = {
  ...
  [FORMAT_PARTS.EPOCH_MS]: { fn: '_getFormatEpoch', args: ['ms'] },
  [FORMAT_PARTS.EPOCH_S]: { fn: '_getFormatEpoch', args: ['s'] },
  [FORMAT_PARTS.DAY_NAME_LONG]: { fn: '_getFormatDayName', args: ['long'] },
  [FORMAT_PARTS.DAY_NAME_SHORT]: { fn: '_getFormatDayName', args: ['short'] },
